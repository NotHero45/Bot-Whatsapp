...
rows: [
{title: `🔖 ${emot} SEWA`, rowId: ".sewa", description: "Menampilkan list harga sewa SasukeBotz"},
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: sgc,
    ...
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/2bf9c8e756c51d93738df.jpg')).buffer(),
    sourceUrl: sgc
 	  /*   sourceUrl: sig,
           title: '◄⟬ ●━━━ ⧏ ⧎ ⧐ ━━━● ⟭►',  
            body: 'Now Playing...', 
